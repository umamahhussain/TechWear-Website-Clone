<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="techwear.Cart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="flex-container">
        <div class="image">
            <asp:Image ID="Image5" runat="server" ImageUrl="~/Images/pants.jpg" AlternateText="pants" Width="500" />
        </div>
        <div class="text">
    ...
    <div class="bottom-bar">
        <asp:Button ID="Button1" runat="server" CssClass="bottom-button" Text="Checkout $29.99" />
    </div>
</asp:Content>
